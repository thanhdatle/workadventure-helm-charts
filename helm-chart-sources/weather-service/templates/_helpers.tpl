...
helm.sh/chart: {{ include "weather-service.chart" . }}
...
{{- default (include "weather-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- printf "%s" (include "weather-service.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
